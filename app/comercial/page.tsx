...
export default function Comercial() {
  return (
    <>
      <HeroSection
        title="Soluciones Eléctricas para el Sector Comercial"
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          {/* Desafíos */}
          <div className="mb-16">
            <h2 className="section-title mb-8">Desafíos Típicos del Sector</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-6 border-l-4 border-innova-accent bg-gray-50 rounded">
                ...
                <p className="text-innova-neutral">
                  Necesidad de sistemas sin interrupciones para garantizar continuidad operativa en espacios con ocupación continua.
                </p>
              </div>
              <div className="p-6 border-l-4 border-innova-accent bg-gray-50 rounded">
                <h3 className="font-bold text-innova-primary mb-2">Eficiencia Energética</h3>
                <p className="text-innova-neutral">
                  Optimización de consumo para reducir costos operativos y cumplir objetivos de sostenibilidad.
                </p>
              </div>
              <div className="p-6 border-l-4 border-innova-accent bg-gray-50 rounded">
              ...
              <div className="p-6 border-l-4 border-innova-accent bg-gray-50 rounded">
                ...
                <p className="text-innova-neutral">
                  Adhesión a códigos de construcción, estándares eléctricos y regulaciones de seguridad.
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Soluciones */}
          <div className="mb-16">
            <h2 className="section-title mb-8">Cómo Abordamos Estos Desafíos</h2>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-sm">Sistemas de fuerza ininterrumpible con múltiples caminos de alimentación</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <span className="text-innova-accent font-bold mr-3">✓</span>
                  <div>
                    ...
                    <p className="text-blue-100 text-sm">Equipos que reducen pérdidas de energía significativamente</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <span className="text-innova-accent font-bold mr-3">✓</span>
                ...
                <li className="flex items-start">
                  <span className="text-innova-accent font-bold mr-3">✓</span>
                  <div>
                    <p className="font-bold">Documentación Integral</p>
                    <p className="text-blue-100 text-sm">Reportes técnicos completos para auditorías y certificaciones</p>
                  </div>
                </li>
              </ul>
            </div>
          ...
          {/* Casos */}
          <div className="mb-16">
            <h2 className="section-title mb-8">Casos de Éxito en el Sector Comercial</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <CaseCard
                ...
                description="Suministro eléctrico para 120+ locales con capacidad de 5 MW"
              />
              <CaseCard
                id="caso-comercial-3"
          ...
          {/* Especificaciones */}
          <div>
            <h2 className="section-title mb-8">Especificaciones Técnicas Comunes</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-innova-neutral">
                  <li>• Media Tensión: 6 kV, 10 kV, 13.8 kV</li>
                  <li>• Baja Tensión: 208V, 240V, 480V</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-innova-accent text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">
            ¿Tu proyecto comercial necesita una solución eléctrica?
          </h2>
