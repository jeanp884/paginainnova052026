    ...
    <>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          {/* Desafios */}
          <div className="mb-16">
            <h2 className="section-title mb-8">Desafios del Sector Utilities</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="p-6 border-l-4 border-innova-accent bg-gray-50 rounded">
                <h3 className="font-bold text-innova-primary mb-2">Regulacion Estricta</h3>
                <p className="text-innova-neutral">
                  Cumplimiento de estandares internacionales y normativas nacionales de operacion.
                </p>
              </div>
              <div className="p-6 border-l-4 border-innova-accent bg-gray-50 rounded">
                <h3 className="font-bold text-innova-primary mb-2">Integracion de Renovables</h3>
                <p className="text-innova-neutral">
                  Adaptacion de redes para incorporar generacion distribuida y fuentes variables.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-innova-secondary text-white p-8 rounded-lg">
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  <span className="text-innova-accent font-bold mr-3">OK</span>
                  <div>
                    <p className="font-bold">Sistemas SCADA y Automatizacion</p>
                    <p className="text-blue-100 text-sm">Control supervisado en tiempo real de operaciones criticas</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <span className="text-innova-accent font-bold mr-3">OK</span>
                  <div>
                    ...
                    <p className="text-blue-100 text-sm">Analisis transitorios y dinamicos de redes complejas</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <span className="text-innova-accent font-bold mr-3">OK</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="p-6 bg-gray-50 rounded-lg">
                ...
                <ul className="text-innova-neutral text-sm space-y-1">
                  ...
                  <li>- Inspecciones termograficas</li>
                  <li>- Estudios de ingenieria</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-innova-accent text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">
            Tu empresa de utilities necesita un socio tecnico confiable?
          </h2>
